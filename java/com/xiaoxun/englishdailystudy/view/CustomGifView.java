...
public class CustomGifView extends View {
    ...
    private void setViewAttributes(Context context, AttributeSet attrs,
        ...
        final TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.CustomGifView);
        mMovieResourceId = array.getResourceId(R.styleable.CustomGifView_gif, -1);
        mPaused = array.getBoolean(R.styleable.CustomGifView_paused, false);
        array.recycle();
